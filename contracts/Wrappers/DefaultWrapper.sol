 ...
 */
abstract contract CollectionWrapper is IERC165, ICollectionWrapper{
    ...
    * 
    */
    function transferFrom(address _from, address _to,uint256 _tokenId,uint256 _quantity) public view virtual returns (bool){
        if(ownerOf(_tokenId,_from)==_from){
            return true;
        }
        return false;
    }
